...
void Lab8::Init()
{
    ...
    // Light & material properties
    {
        ...
        lightPosition2 = glm::vec3(2, 0.5, 0);
...
void Lab8::Update(float deltaTimeSeconds)
{
...

    {
        ...
        // TODO(student): Add or change the object colors
        //glm::vec3(1, 0, 0)
        RenderSimpleMesh(meshes["box"], shaders["LabShader"], modelMatrix, glm::vec3(0.933f, 0.510f, 0.933f));
...
void Lab8::RenderSimpleMesh(Mesh *mesh, Shader *shader, const glm::mat4 & modelMatrix, const glm::vec3 &color)
{
    ...
    // uniform isSpotlight
    GLint spot = glGetUniformLocation(shader->program, "isSpotlight");
    glUniform1i(spot, isSpotlight);
